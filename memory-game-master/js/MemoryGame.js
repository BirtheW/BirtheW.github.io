      ...
      if (!this.cards[index].isRevealed) {
        ...
        if (cardSelection.length == 2) {
          ...
          if (this.cards[cardSelection[0]].value !=
            ...
            status.code = 3,
            status.message = 'Helaas. Verberg kaarten.';
            ...
            if (revealedCards == this.cards.length) {
              ...
              revealedValues = [];
              status.code = 4,
              status.message = 'Helaas! Pogingen: ' + this.attempts +
                  ', fouten: ' + this.mistakes;
            }
            else {
              status.code = 2,
              status.message = 'Joepie';
            }
          }
          cardSelection = [];
        }
          ...
          status.code = 1,
          status.message = 'Draai de eerste kaart om.';
        }
      }
      else {
        status.code = 0,
        status.message = 'Kies een andere kaart.';
      }
